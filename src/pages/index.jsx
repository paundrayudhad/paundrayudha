...
export default function Home() {
    return (
        <>
            <Head>
                <title>Paundra Yudha Dharmawan | Junior Web Developer</title>
                <meta
                    name="description"
            ...
            <Container className="mt-9 w-full">
                <div className="w-full">
                        ...
                        <span className="flex gap-1.5">
                            ...
                            <Typewriter
                                onInit={(typewriter) => {
                                    typewriter
                                        .typeString(
                                            '<span style="color: #27ae60;">Paundra Yudha Dharmawan</span>'
                                        )
                                        .pauseFor(500)
                                        .deleteChars(25)
                                        .start()
                    ...
                    <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400 max-w-2xl">
                        Lulusan baru SMK jurusan Rekayasa Perangkat Lunak dengan minat kuat di bidang
                        pengembangan web. Memiliki pemahaman dasar HTML, CSS, JavaScript, dan PHP serta
                        pengalaman menggunakan framework seperti Laravel dan Bootstrap melalui proyek sekolah dan
                        pribadi. Terbiasa menggunakan Git untuk version control dan mampu bekerja dalam tim maupun
                        secara mandiri. Antusias mempelajari teknologi baru dan siap berkontribusi dalam tim developer
